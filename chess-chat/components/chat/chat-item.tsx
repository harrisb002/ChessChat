...
export const ChatItem = ({
  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <a
              ...
              className="relative aspect-square rounded-md mt-2 overflow-hidden border flex items-center bg-secondary h-24 w-24"
            >
              <Image
                src={fileUrl}
                alt={content}
          ...
          {isPDF && (
            <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hl-2 text-sm text-indigo-500 dark:text-indigo-400 hover:underline"
              >
                PDF File
              </a>
            </div>
      ...
      {canDeleteMessage && (
        <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-900 border rounder-sm">
          {canEditMessage && (
